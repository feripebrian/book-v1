                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <tr>
                          ...
                          <td><input name="akses[]" value="dasbor/profile_sekolah" type="checkbox" class="checkbox"> Baca</td>
                        </tr>
                        <tr>
                          <td>Visi dan Misi</td>
                          <td><input name="akses[]" value="dasbor/visi_dan_misi" type="checkbox" class="checkbox"> Baca</td>
                        </tr>
                        <tr>
                          <td>Buku</td>
                          <td><input name="akses[]" value="dasbor/buku" type="checkbox" class="checkbox"> Baca</td>
                        </tr>
                        <tr>
                          <td>Kategori Buku</td>
                          <td><input name="akses[]" value="dasbor/kategori" type="checkbox" class="checkbox"> Baca</td>
                        </tr>
                        <tr>
                          <td>Saran Buku</td>
                          <td><input name="akses[]" value="dasbor/saran_buku" type="checkbox" class="checkbox"> Baca</td>
                        </tr>
                        <tr>
                          <td>Video Edukasi</td>
                          <td><input name="akses[]" value="dasbor/video_edukasi" type="checkbox" class="checkbox"> Baca</td>
                        </tr>
                        <tr>
                          <td>Galeri</td>
                          <td><input name="akses[]" value="dasbor/galeri" type="checkbox" class="checkbox"> Baca</td>
                        </tr>
